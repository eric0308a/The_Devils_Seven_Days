	...
	var event_data = {
		...
		"pages":[{
			...
			"list":[
				...
				{"code":108,"indent":0,"parameters":["=>自定义照明 : 照明["+_light_a+"]"]},			//自定义照明效果
...
Game_Character.prototype.setMoveRoute = function(moveRoute) {
	moveRoute.list = this.drill_BoC_moveRouteTransform(moveRoute.list);
	_drill_BoC_setMoveRoute.call(this, moveRoute);
};
//==============================
// * 路线 - 函数设置路线
//==============================
...
Game_Character.prototype.forceMoveRoute = function(moveRoute) {
	moveRoute.list = this.drill_BoC_moveRouteTransform(moveRoute.list);
	_drill_BoC_forceMoveRoute.call(this, moveRoute);
};
//==============================
// * 路线 - 修改路线内容
//==============================
