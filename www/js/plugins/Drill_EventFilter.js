		...
		if(args.length == 8 || args.length == 10){
			...
			if( unit == "领队" ){
				...
				if( type == "纯色滤镜" ){
					...
					$gamePlayer._drill_EvF.setPureLinear = [temp1,temp2,temp3];
				}
				if( type == "着色滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setColorLinear = [temp1,temp2,temp3];
				}
				if( type == "填充滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setFillLinear = [temp1,temp2,temp3];
				}
				if( type == "模糊滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setBlurLinear = [Number(temp1),temp2];
				}
				if( type == "噪点滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setNoiseLinear = [Number(temp1),temp2];
				}
				if( type == "波动纯色滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setPureWave = [temp1,temp2,temp3];
				}
				if( type == "波动着色滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setColorWave = [temp1,temp2,temp3];
				}
				if( type == "波动填充滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setFillWave = [temp1,temp2,temp3];
				}
				if( type == "波动模糊滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setBlurWave = [Number(temp1),temp2];
				}
				if( type == "波动噪点滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					$gamePlayer._drill_EvF.setNoiseWave = [Number(temp1),temp2];
				}
			}
			if( unit == "全部队员" ){
				var type = String(args[3]);
				...
				if( type == "纯色滤镜" ){
					...
					$gamePlayer.followers().forEach(function(f){ 
						...
						f._drill_EvF.setPureLinear = [temp1,temp2,temp3]; 
					},this);
				}
				if( type == "着色滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setColorLinear = [temp1,temp2,temp3]; 
					},this);
				}
				if( type == "填充滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setFillLinear = [temp1,temp2,temp3]; 
					},this);
				}
				if( type == "模糊滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setBlurLinear = [Number(temp1),temp2];
					},this);
				}
				if( type == "噪点滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setNoiseLinear = [Number(temp1),temp2];
					},this);
				}
				if( type == "波动纯色滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setPureWave = [temp1,temp2,temp3]; 
					},this);
				}
				if( type == "波动着色滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){ 
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setColorWave = [temp1,temp2,temp3]; 
					},this);
				}
				if( type == "波动填充滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){ 
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setFillWave = [temp1,temp2,temp3]; 
					},this);
				}
				if( type == "波动模糊滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){ 
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setBlurWave = [Number(temp1),temp2]; 
					},this);
				}
				if( type == "波动噪点滤镜" ){
					$gamePlayer._drill_EvF.openFilter = true;
					...
					$gamePlayer.followers().forEach(function(f){ 
						f._drill_EvF.openFilter = true;
						f._drill_EvF.setNoiseWave = [Number(temp1),temp2]; 
					},this);
				}
			}
			if( unit == "本事件" ){
				...
				if( type == "纯色滤镜" ){
					...
					e._drill_EvF.setPureLinear = [temp1,temp2,temp3];
				}
				if( type == "着色滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setColorLinear = [temp1,temp2,temp3];
				}
				if( type == "填充滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setFillLinear = [temp1,temp2,temp3];
				}
				if( type == "模糊滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setBlurLinear = [Number(temp1),temp2];
				}
				if( type == "噪点滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setNoiseLinear = [Number(temp1),temp2];
				}
				if( type == "波动纯色滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setPureWave = [temp1,temp2,temp3];
				}
				if( type == "波动着色滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setColorWave = [temp1,temp2,temp3];
				}
				if( type == "波动填充滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setFillWave = [temp1,temp2,temp3];
				}
				if( type == "波动模糊滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setBlurWave = [Number(temp1),temp2];
				}
				if( type == "波动噪点滤镜" ){
					e._drill_EvF.openFilter = true;
					e._drill_EvF.setNoiseWave = [Number(temp1),temp2];
				}
			}
		}
		if(args.length == 10 || args.length == 12){
			...
			if( unit == "指定队员" || unit == "指定队员(变量)" ){
				...
				if( type == "纯色滤镜" ){
					...
					_followers[index]._drill_EvF.setPureLinear = [temp1,temp2,temp3];
				}
				if( type == "着色滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setColorLinear = [temp1,temp2,temp3];
				}
				if( type == "填充滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setFillLinear = [temp1,temp2,temp3];
				}
				if( type == "模糊滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setBlurLinear = [Number(temp1),temp2];
				}
				if( type == "噪点滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setNoiseLinear = [Number(temp1),temp2];
				}
				if( type == "波动纯色滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setPureWave = [temp1,temp2,temp3];
				}
				if( type == "波动着色滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setColorWave = [temp1,temp2,temp3];
				}
				if( type == "波动填充滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setFillWave = [temp1,temp2,temp3];
				}
				if( type == "波动模糊滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setBlurWave = [Number(temp1),temp2];
				}
				if( type == "波动噪点滤镜" ){
					_followers[index]._drill_EvF.openFilter = true;
					_followers[index]._drill_EvF.setNoiseWave = [Number(temp1),temp2];
				}
			}
			...
			if (command == "=>行走图滤镜"){
				if(args.length >= 2 && args.length <= 4){
					...
					if( type == "纯色滤镜" ){	//=>行走图滤镜 : 纯色滤镜 : 纯蓝 : 155
						...
						this._drill_EvF.setPureLinear = [temp1,temp2,temp3];
					}
					if( type == "着色滤镜" ){
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setColorLinear = [temp1,temp2,temp3];
					}
					if( type == "填充滤镜" ){
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setFillLinear = [temp1,temp2,temp3];
					}
					if( type == "模糊滤镜" ){	//=>行走图滤镜 : 噪点滤镜 : 55
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setBlurLinear = [Number(temp1),temp2];
					}
					if( type == "噪点滤镜" ){
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setNoiseLinear = [Number(temp1),temp2];
					}
					if( type == "波动纯色滤镜" ){	//=>行走图滤镜 : 波动纯色滤镜 : 纯蓝 : 55 : 60
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setPureWave = [temp1,temp2,temp3];
					}
					if( type == "波动着色滤镜" ){
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setColorWave = [temp1,temp2,temp3];
					}
					if( type == "波动填充滤镜" ){
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setFillWave = [temp1,temp2,temp3];
					}
					if( type == "波动模糊滤镜" ){	//=>行走图滤镜 : 波动噪点滤镜 : 55 : 60
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setBlurWave = [Number(temp1),temp2];
					}
					if( type == "波动噪点滤镜" ){
						this._drill_EvF.openFilter = true;
						this._drill_EvF.setNoiseWave = [Number(temp1),temp2];
					}
				}
			};
		};
