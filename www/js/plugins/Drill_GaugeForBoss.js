...
/*:
 * @plugindesc [v1.7]        UI - 高级BOSS生命固定框
 * @author Drill_up
 * 
 ...
 *   放置在 战斗上层 。
 * 2.更多内容可以去看看文档"关于高级BOSS生命固定框.docx"。
...
　　var DrillUp = DrillUp || {}; 
	...
	for (var i = 0; i < DrillUp.g_GFB_styleList_length; i++) {
		if( DrillUp.parameters["固定框样式-" + String(i+1) ] != "" ){
			DrillUp.g_GFB_styleList[i] = JSON.parse(DrillUp.parameters["固定框样式-" + String(i+1) ]);
