...
Graphics._createAllElements = function() {
	this.drill_HB_createCanvas();
	this.drill_HB_createRenderer();
	_drill_HB_createAllElements.call(this);
}
//==============================
// * 初始化 - canvas
//==============================
Graphics.drill_HB_createCanvas = function() {
...
// * 初始化 - render
//==============================
Graphics.drill_HB_createRenderer = function() {
	PIXI.dontSayHello = true;
	var width = DrillUp.drill_HB_width();
	var height = DrillUp.drill_HB_height();
	...
	try {
		...
		if(this._drill_HB_renderer && this._drill_HB_renderer.textureGC){
			this._drill_HB_renderer.textureGC.maxIdle = 1;
		}
	} catch (e) {
...
Graphics.drill_HB_updateCanvas = function() {
	...
	this._drill_HB_canvas.style.height = DrillUp.drill_HB_height();
...
SceneManager.renderScene = function() {
	...
	if ( this._drill_HB_scene.isReady() ) {
		this._drill_HB_scene.drill_setSize( DrillUp.drill_HB_width(),DrillUp.drill_HB_height() );
		this._drill_HB_scene.update();
		Graphics.drill_HB_render(this._drill_HB_scene);
	}
}
