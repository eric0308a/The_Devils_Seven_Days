 ...
 *   (2.你可以设置扩展键的几个键为同一个键位，节约按键，但是要注意对应
 *      键起效的时机，场景等情况。
 * 键位适配：
 *   (1.手柄因为键位少，所以固定了功能键的设置。
 *      键盘就可以完全灵活设置，任意一个或两个键都可以触发，并且几个键
 *      可以作用于同一个功能。
 *   (2.注意，该插件有可能覆盖掉其他插件的某些自定义按键设置，你需要调
 *      整一下插件先后位置。如果按键仍然不起效果，那么只能做插件取舍了。
 * 特殊键盘按键：
