...
　　var DrillUp = DrillUp || {}; 
	...
	/*-----------------选项窗口------------------*/
	DrillUp.g_SSpI_selWin_x = Number(DrillUp.parameters['选项窗口 X'] || 30);
	DrillUp.g_SSpI_selWin_y = Number(DrillUp.parameters['选项窗口 Y'] || 120);
	DrillUp.g_SSpI_selWin_width = Number(DrillUp.parameters['选项窗口宽度'] || 220);
	DrillUp.g_SSpI_selWin_height = Number(DrillUp.parameters['选项窗口高度'] || 460);
	DrillUp.g_SSpI_selWin_fontsize = Number(DrillUp.parameters['选项窗口字体大小'] || 22);
	DrillUp.g_SSpI_selWin_col = Number(DrillUp.parameters['选项窗口列数'] || 1);
    DrillUp.g_SSpI_selWin_align = String(DrillUp.parameters['选项窗口对齐方式'] || "左对齐");
	if( DrillUp.parameters['选项窗口移动动画'] != undefined ){
		DrillUp.g_SSpI_selWin_slideAnim = JSON.parse( DrillUp.parameters['选项窗口移动动画'] );
		DrillUp.g_SSpI_selWin_slideAnim['slideMoveType'] = String(DrillUp.g_SSpI_selWin_slideAnim['移动类型'] || "匀速移动");
		DrillUp.g_SSpI_selWin_slideAnim['slideTime'] = Number(DrillUp.g_SSpI_selWin_slideAnim['移动时长'] || 20);
		DrillUp.g_SSpI_selWin_slideAnim['slideDelay'] = Number(DrillUp.g_SSpI_selWin_slideAnim['移动延迟'] || 0);
		DrillUp.g_SSpI_selWin_slideAnim['slidePosType'] = String(DrillUp.g_SSpI_selWin_slideAnim['坐标类型'] || "相对坐标");
		DrillUp.g_SSpI_selWin_slideAnim['slideX'] = Number(DrillUp.g_SSpI_selWin_slideAnim['起点-相对坐标 X'] || -100);
		DrillUp.g_SSpI_selWin_slideAnim['slideY'] = Number(DrillUp.g_SSpI_selWin_slideAnim['起点-相对坐标 Y'] || 0);
		DrillUp.g_SSpI_selWin_slideAnim['slideAbsoluteX'] = Number(DrillUp.g_SSpI_selWin_slideAnim['起点-绝对坐标 X'] || 0);
		DrillUp.g_SSpI_selWin_slideAnim['slideAbsoluteY'] = Number(DrillUp.g_SSpI_selWin_slideAnim['起点-绝对坐标 Y'] || 0);
	}else{
		DrillUp.g_SSpI_selWin_slideAnim = {};
	}
	if( DrillUp.parameters['选项窗口布局'] != undefined ){
		DrillUp.g_SSpI_selWin_layout = JSON.parse( DrillUp.parameters['选项窗口布局'] );
		DrillUp.g_SSpI_selWin_layout['layoutType'] = String(DrillUp.g_SSpI_selWin_layout['布局类型'] || "默认皮肤");
		DrillUp.g_SSpI_selWin_layout['layoutSrc'] = String(DrillUp.g_SSpI_selWin_layout['资源-贴图'] || "");
		DrillUp.g_SSpI_selWin_layout['layoutSrcFile'] = "img/Menu__self/";
		DrillUp.g_SSpI_selWin_layout['layoutX'] = Number(DrillUp.g_SSpI_selWin_layout['贴图位置修正 X'] || -100);
		DrillUp.g_SSpI_selWin_layout['layoutY'] = Number(DrillUp.g_SSpI_selWin_layout['贴图位置修正 Y'] || 0);
	}else{
		DrillUp.g_SSpI_selWin_layout = {};
	}
...
// * 创建 - 整体布局
//==============================
Scene_Drill_SSpI.prototype.createLayout = function() {
...
// * 创建 - 选项窗口
//==============================
Scene_Drill_SSpI.prototype.createSelect = function() {
	var data = {
		"x": DrillUp.g_SSpI_selWin_x,
		"y": DrillUp.g_SSpI_selWin_y,
		"width": DrillUp.g_SSpI_selWin_width,
		"height": DrillUp.g_SSpI_selWin_height,
		"fontsize": DrillUp.g_SSpI_selWin_fontsize,
		
		"slideMoveType": DrillUp.g_SSpI_selWin_slideAnim['slideMoveType'],
		"slideTime": DrillUp.g_SSpI_selWin_slideAnim['slideTime'],
		"slideDelay": DrillUp.g_SSpI_selWin_slideAnim['slideDelay'],
		"slidePosType": DrillUp.g_SSpI_selWin_slideAnim['slidePosType'],
		"slideX": DrillUp.g_SSpI_selWin_slideAnim['slideX'],
		"slideY": DrillUp.g_SSpI_selWin_slideAnim['slideY'],
		"slideAbsoluteX": DrillUp.g_SSpI_selWin_slideAnim['slideAbsoluteX'],
		"slideAbsoluteY": DrillUp.g_SSpI_selWin_slideAnim['slideAbsoluteY'],
		
		"layoutType": DrillUp.g_SSpI_selWin_layout['layoutType'],
		"layoutX": DrillUp.g_SSpI_selWin_layout['layoutX'],
		"layoutY": DrillUp.g_SSpI_selWin_layout['layoutY'],
		"layoutSrc": DrillUp.g_SSpI_selWin_layout['layoutSrc'],
		"layoutSrcFile": DrillUp.g_SSpI_selWin_layout['layoutSrcFile'],
	}
...
// * 创建 - 描述窗口
//==============================
Scene_Drill_SSpI.prototype.createDesc = function() {
	var data = {
...
// * 创建 - 描述图片
//==============================
Scene_Drill_SSpI.prototype.createDescPic = function() {
	var data = {
...
Drill_SSpI_SelectWindow.prototype.maxCols = function() {
	return DrillUp.g_SSpI_selWin_col;
};
...
Drill_SSpI_SelectWindow.prototype.refresh = function() {
	...
	for(var i=1; i<= DrillUp.g_SSpI_context_list_length ;i++){
		...
		if( DrillUp.g_SSpI_title_data_global ){
			var temp = DrillUp.g_SSpI_context_list[i];	//全局存储
		}else{
			var temp = $gameSystem._drill_SSpI_context_list[i];	//正常存储
		}
...
Drill_SSpI_SelectWindow.prototype.drawItem = function(index) {
	...
	var xx = rect.x;
	if( DrillUp.g_SSpI_selWin_align == "居中" ){
		xx += (rect.width - str_width) * 0.5;
	}else if( DrillUp.g_SSpI_selWin_align == "右对齐" ){
