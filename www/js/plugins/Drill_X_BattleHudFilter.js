...
/*:
 * @plugindesc [v1.3]        战斗UI - 角色窗口的滤镜效果[扩展]
 * @author Drill_up
 *
 *
 * @help  
 ...
 * -----------------------------------------------------------------------------
 * ----插件扩展
 * 插件只对指定插件扩展，如果没有使用 角色窗口 插件，则该插件没有任何效果。
 * 基于：
 ...
 *   二者设置会相互覆盖。
 * 4.如果配置的条件有相互交叉的地方，则按照配置在前面的条件滤镜来变化。
 * 5.框的滤镜效果，满足条件后瞬间变化，没有过度的过程。
 * 6.条件滤镜作用于角色窗口的前布局和后布局，数字、头像、生命条都不包括。
...
// * >>>>基于插件检测>>>>
//=============================================================================
if( Imported.MOG_BattleHud && Imported.Drill_CoreOfFilter ){
