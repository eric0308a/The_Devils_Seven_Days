...
/*:
 * @plugindesc [v1.3]        控件 - 物品+技能详细图片[扩展]
 * @author Drill_up
 *
 * @help  
 * =============================================================================
...
// * >>>>基于插件检测>>>>
//=============================================================================
if( Imported.Drill_RotateCard && ImageManager.load_MenuCard !== undefined ){

//=============================================================================
// ** 图片初始化
//=============================================================================
var _drill_XII_initialize = Game_System.prototype.initialize;
Game_System.prototype.initialize = function() {
	_drill_XII_initialize.call(this);
	//暂时不全读取，还是在用的时候再读取吧，可能会炸
}
//=============================================================================
// ** 旋转卡牌修改
//=============================================================================
