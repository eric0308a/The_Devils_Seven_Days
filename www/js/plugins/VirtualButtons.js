...
(function() {
    ...
    function addToggleButtonListeners(btn, container) {
        ...
        btn.addEventListener('pointerdown', consumeEvent);
        btn.addEventListener('pointerup', consumeEvent);
    }
    ...
    function addButtonEventListeners(button, key) {
        ...
        button.addEventListener('click', consumeEvent);
        ...
        document.addEventListener('mouseup', (e) => {
            ...
            if (e && e.target && e.target.closest && e.target.closest('#virtual-buttons-container')) {
                consumeEvent(e);
            }
        }, true);
